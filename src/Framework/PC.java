...
public class PC {
    ...
    /**
     * This constructor initializes the player in the given room.
     *
    ...
    /**
     * This constructor initializes the player with the potential for keeping inventory items.
     *
     * @param currentRoom - the current room the player is in
     * @param inventory   - All items the player is currently carrying
     */
     ...
     *
     * @param direction - the direction string that the player input
     * @return String of success or not.
     */
                ...
                switch (direction[1]) {
                    case "NORTH":
                        if (currentRoom.getPortalNorth() == null) {
                            break;
                        } else if (currentRoom.getID() == 7 && beastSlain && getInventory().contains(getItem("ORB"))) {
